...
#define cerror BLOG(dev::g_errorLogger::get())
...
#define cwarn BLOG(dev::g_warnLogger::get())
...
#define cnote BLOG(dev::g_noteLogger::get())
...
#define cdebug BLOG(dev::g_debugLogger::get())
...
#define ctrace BLOG(dev::g_traceLogger::get())
